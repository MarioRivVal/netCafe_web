    ...
    <section class="section section-testimonials">
        <div class="testimonials">
            ...
            <div class="testimonials__container">  
             ...
             <img class="blast-img testimonials__blast-img--right hidden hidden-img-right" src="./img/blast-right.png" style="--i:0"> 
             <img class="blast-img testimonials__blast-img--left hidden hidden-img-left" src="./img/blast-left-up.png" style="--i:1"> 
        </div>
    </section>
    `;
};
