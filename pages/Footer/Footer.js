...
export const Footer = () => `
    <footer>
        <div class="footer__form">
            <img class="footer__img-cup footer__img-cup--right hidden hidden-img-right " src="./img/cup-right.png">
            <img class="footer__img-cup footer__img-cup--left hidden hidden-img-left" src="./img/cup-left.png">
